...
def run_training_entry():
    ...
    parser.add_argument('-dataset_name_or_id', default='802', required=False, type=str,
                        help="Dataset name or ID to train with")
    # parser.add_argument('configuration', type=str,
    #                     help="Configuration that should be trained")
    # parser.add_argument('-configuration', default='3d_fullres', required=False, type=str,
    #                     help="Configuration that should be trained")
    parser.add_argument('-configuration', default='3d_lowres', required=False, type=str,
                        help="Configuration that should be trained")
    # parser.add_argument('fold', type=str,
    #                     help='Fold of the 5-fold cross-validation. Should be an int between 0 and 4.')
    parser.add_argument('-fold', default='all', required=False, type=str,
                        help='Fold of the 5-fold cross-validation. Should be an int between 0 and 4.')
